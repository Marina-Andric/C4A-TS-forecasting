...
def get_optimal_hmms_for_users_single_variate(userId, dvId, data, cov_type):
    activities = get_list_activities(userId, dvId)  # dictionary of GES and corresponding Measures
    dict_activity = {}
